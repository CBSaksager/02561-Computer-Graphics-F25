...
async function main() {
  ...
  var positions = [];
  add_point(positions, vec2(0.0, 0.0), point_size); // Center
  add_point(positions, vec2(1, 0.0), point_size); // Center-right
  add_point(positions, vec2(1, 1), point_size); // Top-right
